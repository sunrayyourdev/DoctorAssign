...
_Prerequisite_ - [Docker](https://www.docker.com) must be installed and running for the commands below to work! (You need to install docker desktop to start and stop containers, follow the online documentation.)
